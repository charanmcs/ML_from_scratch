...
y = [int(i) for i in y]
# Extracting the features (petal length and width)
X = data[:, [2,3]]    #Taking in petal length and width
...
model.save("LogisticRegression\modelWeights\TrainedWithPetalDimensions.pkl")
